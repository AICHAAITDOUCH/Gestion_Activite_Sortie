...
// ✅ Requête pour afficher toutes les activités + infos utilisateur
...
<body>
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                     ...
                     <h1 class="card-title" style="color: #4B49AC; font-size:x-large; text-decoration:underline" >Liste Users</h1>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          <td class="py-1">
                            <img src="../../../uploads/<?php echo htmlspecialchars($a['photo_profil']); ?>" alt="image" width="40" height="40" style="border-radius:50%;"/>
                          </td>
                          <td>
  ...
  <input type="hidden" name="id_activite" value="<?php echo $a['id_activite']; ?>">
  <input type="hidden" name="titre" value="<?php echo htmlspecialchars($a['titre']); ?>">
  <input type="hidden" name="date" value="<?php echo htmlspecialchars($a['date_activite']); ?>">
  <input type="hidden" name="description" value="<?php echo htmlspecialchars($a['description']); ?>">
  <input type="hidden" name="photo" value="<?php echo htmlspecialchars($a['photo']); ?>">

  <button type="submit" class="btn btn-primary" name="confirmer"> Confirmer <span style="margin-left: 10px;"><i class="fa-solid fa-circle-check"></i></span></button>
</form>
